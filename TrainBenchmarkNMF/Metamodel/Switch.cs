...
namespace TTC2015.TrainBenchmark.Railway
{
    ...
    public partial class Switch : TrackElement, ISwitch, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2015.TrainBenchmark.Railway.Switch.ClassInstance)).Resolve("currentPosition")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2015.TrainBenchmark.Railway.Switch.ClassInstance)).Resolve("positions")));
        }
        ...
        private void PositionsCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
