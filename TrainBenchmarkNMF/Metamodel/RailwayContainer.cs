...
namespace TTC2015.TrainBenchmark.Railway
{
    ...
    public partial class RailwayContainer : ModelElement, IRailwayContainer, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2015.TrainBenchmark.Railway.RailwayContainer.ClassInstance)).Resolve("invalids")));
        }
        ...
        private void InvalidsCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2015.TrainBenchmark.Railway.RailwayContainer.ClassInstance)).Resolve("semaphores")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void SemaphoresCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2015.TrainBenchmark.Railway.RailwayContainer.ClassInstance)).Resolve("routes")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void RoutesCollectionChanging(object sender, NotifyCollectionChangingEventArgs e)
        {
